...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (readCount < totalDays) {
        cell.detailTextLabel.textColor = dark ? [UIColor colorWithWhite:0.5 alpha:1.0] : sepia ? [UIColor colorWithRed:0.55 green:0.40 blue:0.25 alpha:1.0] : [UIColor grayColor];
    }
